...
extern SM64_LIB_FN void sm64_set_mario_action_timer(int32_t marioId, uint32_t actionTimer);
...
extern SM64_LIB_FN void sm64_set_mario_bonus_speed(int32_t marioId, float speed);
...
extern SM64_LIB_FN void sm64_set_mario_can_recover(int32_t marioId, uint8_t canRecover);
